...
func GenerateGoSchema(sref *openapi3.SchemaRef, path []string, other ...bool) (Schema, error) {
	...
	if len(other) == 0 || !other[0] {
		refPath, match := openapi3.ReferencesComponentInRootDocument(globalState.spec, sref)
